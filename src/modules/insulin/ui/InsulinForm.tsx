...
import { SaveInsulinLog } from "../application/usecases/SaveInsulinLog";
import { InsulinRepoSupabase } from "../infrastructure/adapters/InsulinRepo.supabase";
...
export default function InsulinForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res.ok && res.status === 201) {
      alert("Đã ghi liều insulin ✅");
      setDose("");
    } else {
      alert(res.error ?? "Ghi log thất bại. Vui lòng thử lại.");
    }
  }
